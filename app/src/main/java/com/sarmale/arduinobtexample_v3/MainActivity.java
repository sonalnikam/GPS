...
// Initialize GPSTracker in onCreate() or onCreateView() method
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mGPSTracker = new GPSTracker(this, new GPSTracker.OnLocationChangeListener() {
            @Override
        ...
        clearValues.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                btDevices.setText("");
                btReadings.setText("");
                String currentLocation = mGPSTracker.getCurrentLocation();

                // Send SMS

                SmsManager smsManager = SmsManager.getDefault();
                String phoneNumber = "9004791373";

                String url = "https://www.google.com/maps?q=" + currentLocation;
                smsManager.sendTextMessage(phoneNumber, null, url, null, null);
            }
        });
